from detector_Pluzhnikov import Recognizer
from AntiSpoof.FaceAntiSpoofing import AntiSpoof


class AntiSpoofSystem(Recognizer):
    
    def __init__(self, spoof_model_path='saved_models/AntiSpoofing_bin_1.5_128.onnx') -> None:
        """Конструктор
        """
        super().__init__()
